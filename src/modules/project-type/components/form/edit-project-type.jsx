...
import { apiPut } from '../../../../services/project-type.services';

export const FormEditProjectType = ({ data, setUpdate }) => {
  ...
  const onSubmit = dataInputProjectType => {
    apiPut(localItem, dataInputProjectType); //Update data to localStorage
    dispatch(action.updateProjectType(dataInputProjectType)); //Update state
    setIsDisabled(true);
    setTimeout(() => {
      setUpdate(false);
    }, delay);
  ...
  return (
    <div className='flex justify-center'>
      ...
      <div className='w-1/2'>
        <div className='mt-10'>
          <div className='flex justify-center'>
            <TableTitle title='Update Project Type:' />
          </div>
