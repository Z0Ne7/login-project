...
export const FormCreateCustomer = () => {
  ...
  const delay = 1000;
  const onSubmit = dataInputCustomer => {
    const idCustomer = dataInputCustomer.id;
    dispatch(action.addCustomer(dataInputCustomer));
    setIsDisabled(true);
    setTimeout(() => {
      history.push('/customers/' + idCustomer);
    }, delay);
  };
  return (
    <div className='w-1/2'>
