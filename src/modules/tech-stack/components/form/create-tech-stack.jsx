...
export const FormCreateTechStack = () => {
  ...
  const onSubmit = dataInputTechStack => {
    const idTechStack = dataInputTechStack.id;
    dispatch(action.addTechStack(dataInputTechStack));
    setIsDisabled(true);
    setTimeout(() => {
      history.push('/tech-stack/' + idTechStack);
    }, delay);
  };
  return (
    <div className='w-1/2'>
      <div className='mt-10'>
        <div className='flex justify-center'>
          <TableTitle title='Add Tech Stack:' />
        </div>
