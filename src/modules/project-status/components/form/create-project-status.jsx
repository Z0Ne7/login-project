...
export const FormCreateProjectStatus = () => {
  ...
  const delay = 1000;
  const onSubmit = dataInputProjectStatus => {
    const idProjectStatus = dataInputProjectStatus.id;
    dispatch(action.addProjectStatus(dataInputProjectStatus));
    setIsDisabled(true);
    setTimeout(() => {
      history.push('/project-status/' + idProjectStatus);
    }, delay);
  };
  return (
    <div className='w-1/2'>
      <div className='mt-10'>
        <div className='flex justify-center'>
          <TableTitle title='Add Project Status:' />
        </div>
